...
double c11= 0.04; // consumption matrix parameter
double c12= 0.04; // consumption matrix parameter
...
double k1_g= 100000; // carrying capacity of prey 1: good year
double k2_g= 100000; // carrying capacity of prey 2: good year

double k1_h= 100; // carrying capacity of prey 1: harsh year
double k2_h= 100; // carrying capacity of prey 2: harsh year

double p1=0.0; //threshold probability. 0~p1: gg
double p2=0.5; //threshold probability. p1~p2: gh
double p3=1; //threshold probability. p2~p3: hg    p3~1: hh
