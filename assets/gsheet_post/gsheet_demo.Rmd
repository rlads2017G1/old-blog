...
以下區塊是 DataCamp Light, 為輔助程式語言教學與學習的工具，可用來執行 R 或 Python。下方的例子執行的是 R 語言，並且已預先讀入資料。您僅需於`score()`中輸入金鑰，例如，若您於問卷中 Token 那題填寫「abcde123」，請於下方輸入`score("abcde123")`。若查無結果，請重新整理頁面後再輸入一次。
...
```{r}
modal_body <- button_bs("Google Sheet", class = "primary", data_toggle = "modal", data_target = "#sheet")
