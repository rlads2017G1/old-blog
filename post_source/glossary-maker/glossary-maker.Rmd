...
mathjax: false
highlight: true
title: "Making a Glossary in R Markdown"
...
So I wrote an R function to help me reorder the definition lists written in R Markdown. Note that this functions **only works for R Markdown files containing defintion lists exclusively**. If the R Markdown files aren't whole-definition-lists, it will fail.
...
[^source]: See the source Rmd file, `glossary.rmd`, [here](https://github.com/liao961120/liao961120.github.io/blob/master/post_source/glossary-maker/glossary.rmd)