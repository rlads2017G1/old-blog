...
mathjax: false
highlight: true
title: "Make Your Jekyll Blog Suitable for R-bloggers"
...
For example, the source of this post(`rblogger-criteria.rmd`) is two layers below the root dir of the web site.
```
+---assets/
...
The last thing to do is to process the output `rblogger-criteria.html`, replacing `<img src="../../assets` with `<img src="/assets` in the `<img>` tag. I do this with a simple bash script:
...
[image source](/assets/rblogger-criteria-img/iris-1.png)
